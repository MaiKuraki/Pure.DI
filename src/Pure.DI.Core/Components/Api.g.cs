...
namespace Pure.DI
{
    ...
    internal interface IConfiguration
    {
        ...
        /// <param name="contextArgName">Composition argument name for the base setup instance.</param>
        /// <summary>
        /// Specifies a base setup and exposes its instance members through a context argument.
        /// <example>
        /// <code>
        ...
        /// <param name="setupName">Name of base composition setup.</param>
        /// <param name="contextArgName">Composition argument name for the base setup instance.</param>
        /// <param name="kind">How the setup context is stored. Default is <see cref="SetupContextKind.Argument"/>.</param>
        /// <returns>Configuration interface for fluent chaining.</returns>
        /// <seealso cref="DI.Setup"/>
        /// <seealso cref="CompositionKind"/>
        /// <seealso cref="SetupContextKind"/>
        IConfiguration DependsOn(string setupName, string contextArgName, SetupContextKind kind = SetupContextKind.Argument);
    ...
    internal static class DI
    {
        ...
        private sealed class Configuration: IConfiguration, IBinding
        {
            ...
            /// <inheritdoc />
            public IConfiguration DependsOn(string setupName, string contextArgName, SetupContextKind kind = SetupContextKind.Argument)
            {
                return this;
            }
