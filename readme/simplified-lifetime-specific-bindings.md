...
partial class Composition
{
  public IShop MyShop
  {
    ...
    get
    {
      var perBlockOrderManager356 = new OrderManager(new OrderNameFormatter());
      return new Shop(perBlockOrderManager356, perBlockOrderManager356, perBlockOrderManager356);
    }
  }
}
```
